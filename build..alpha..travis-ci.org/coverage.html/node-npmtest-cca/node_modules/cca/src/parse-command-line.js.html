...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-cca/node_modules/cca/src/parse-command-line.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-cca/node_modules/cca/src/parse-command-line.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-cca/node_modules/cca/src/</a> &#187; parse-command-line.js</div>
</div>
<div class="body">
...
&nbsp;
module.exports = exports = <span class="fstat-no" title="function not covered" >function parseCommandLine() {</span>
<span class="cstat-no" title="statement not covered" >  var pathToApp = '&lt;' + path.join('path', 'to', 'app') + '&gt;';</span>
<span class="cstat-no" title="statement not covered" >  return optimist</span>
